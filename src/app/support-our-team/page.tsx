    ...
    <main className="min-h-screen bg-gray-50">
      <section className="relative overflow-hidden bg-green-900 text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-24 sm:px-6 lg:px-8">
          <p className="mb-4 inline-flex rounded-full border border-white/30 px-4 py-1 text-xs font-semibold uppercase tracking-[0.18em]">
            Support Our Team
          </p>
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg bg-white px-8 py-3 text-base font-semibold text-green-800 shadow-lg transition-colors hover:bg-green-50"
            >
              Support Our Team
            </button>
            <Link
              href="/"
              className="inline-flex items-center justify-center rounded-lg border border-white/60 px-8 py-3 text-base font-semibold text-white transition-colors hover:bg-white hover:text-green-900"
            >
              Back to Home
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          <h3 className="text-2xl font-extrabold text-gray-900">Why your support matters now</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 py-8">
          <div className="w-full max-w-3xl rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="text-2xl font-extrabold text-gray-900">Fund Our Mission</h2>
            ...
            <div className="mt-6 rounded-xl border border-gray-200 bg-gray-50 p-5">
              <h3 className="text-lg font-bold text-gray-900">1) Select amount</h3>
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <button
                  ...
                  className="inline-flex min-w-[150px] items-center justify-center rounded-lg bg-green-700 px-5 py-2.5 text-sm font-semibold text-white transition-colors enabled:hover:bg-green-800 disabled:cursor-not-allowed disabled:bg-gray-300"
                >
                  Confirm
                </button>
              </div>
            ...
            {isAmountConfirmed && (
              <div className="mt-6">
                <h3 className="text-lg font-bold text-gray-900">2) Choose payment method and proceed</h3>
                <button
                  type="button"
                ...
                {selectedPaymentMethod === 'bank' && (
                  <article className="mt-4 rounded-xl border border-green-100 bg-green-50 p-4">
                    <h4 className="text-lg font-bold text-gray-900">Bank Account</h4>
                ...
                {selectedPaymentMethod === 'momo' && (
                  <article className="mt-4 rounded-xl border border-blue-100 bg-blue-50 p-4">
                    <h4 className="text-lg font-bold text-gray-900">MoMo</h4>
                ...
                {selectedPaymentMethod === 'paypal' && (
                  <article className="mt-4 rounded-xl border border-amber-100 bg-amber-50 p-4">
                    <h4 className="text-lg font-bold text-gray-900">PayPal</h4>
